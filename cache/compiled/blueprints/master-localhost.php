...
return [
    ...
    'data' => [
        'items' => [
            ...
            'themes.hypertext.structure' => [
                'type' => '_parent',
                'name' => 'themes.hypertext.structure',
                'form_field' => false
            ],
            'themes.hypertext.structure.inline_navbar' => [
                'type' => 'toggle',
                ...
                'name' => 'themes.hypertext.structure.inline_navbar',
                'validation' => 'strict'
            ],
            'themes.hypertext.structure.inline_pagination' => [
                'type' => 'toggle',
                ...
                'name' => 'themes.hypertext.structure.inline_pagination',
                'validation' => 'strict'
            ],
            'themes.hypertext.structure.use_decorators' => [
                'type' => 'toggle',
                ...
                'name' => 'themes.hypertext.structure.use_decorators',
                'validation' => 'strict'
            ],
            'themes.hypertext.structure.html_mode' => [
                'type' => 'select',
                'classes' => 'fancy',
                'label' => 'HTML Mode',
                'options' => [
                ...
                'name' => 'themes.hypertext.structure.html_mode',
                'validation' => 'strict'
            ],
            'themes.hypertext.structure.use_favicon' => [
                'type' => 'toggle',
                'label' => 'Use favicon',
                'default' => 0,
                'highlight' => 0,
                ...
                'name' => 'themes.hypertext.structure.use_favicon',
                'validation' => 'strict'
            ],
            'themes.hypertext.structure.show_date' => [
                'type' => 'toggle',
                ...
                'name' => 'themes.hypertext.structure.show_date',
                'validation' => 'strict'
            ],
            'themes.hypertext.style' => [
                'type' => '_parent',
                'name' => 'themes.hypertext.style',
                'form_field' => false
            ],
            'themes.hypertext.style.allowCSS' => [
                'type' => 'toggle',
                'classes' => 'fancy',
                ...
                'name' => 'themes.hypertext.style.allowCSS',
                'validation' => 'strict'
            ],
            'themes.hypertext.style.allowJS' => [
                'type' => 'toggle',
                'classes' => 'fancy',
                ...
                'name' => 'themes.hypertext.style.allowJS',
                'validation' => 'strict'
            ],
            'themes.hypertext.style.stylesheet' => [
                'type' => 'select',
                'classes' => 'fancy',
                ...
                'name' => 'themes.hypertext.style.stylesheet',
                'validation' => 'strict'
            ],
            'themes.hypertext.style.include_type' => [
                'type' => 'select',
                'classes' => 'fancy',
                ...
                'name' => 'themes.hypertext.style.include_type',
                'validation' => 'strict'
            ],
            'themes.hypertext.style.customCSS' => [
                'type' => 'textarea',
                'label' => 'Custom CSS',
                'size' => 'large',
                'name' => 'themes.hypertext.style.customCSS',
                'validation' => 'strict'
            ],
            'themes.hypertext.style.configuration' => [
                'type' => 'select',
                'size' => 'medium',
                'classes' => 'fancy',
                ...
                'name' => 'themes.hypertext.style.configuration',
                'validation' => 'strict'
            ],
            'themes.hypertext.style.width' => [
                'type' => 'select',
                'size' => 'medium',
                'classes' => 'fancy',
                ...
                'name' => 'themes.hypertext.style.width',
                'validation' => 'strict'
            ],
            'themes.hypertext.style.image_cropping' => [
                'type' => 'toggle',
                'size' => 'medium',
                ...
                'name' => 'themes.hypertext.style.image_cropping',
                'validation' => 'strict'
            ],
            'themes.hypertext.menu' => [
                'type' => '_parent',
                'name' => 'themes.hypertext.menu',
                'form_field' => false
            ],
            'themes.hypertext.menu.menuItems' => [
                'name' => 'themes.hypertext.menu.menuItems',
                'type' => 'list',
                'style' => 'vertical',
                'size' => 'long',
            ...
            'themes.hypertext.menu.menuItems.*.text' => [
                'type' => 'text',
                'label' => 'Link Text',
                'name' => 'themes.hypertext.menu.menuItems.*.text',
                'validation' => 'strict'
            ],
            'themes.hypertext.menu.menuItems.*.href' => [
                'type' => 'text',
                'label' => 'Full URL',
                'name' => 'themes.hypertext.menu.menuItems.*.href',
                'validation' => 'strict'
            ],
            'themes.hypertext.menu.menuItems.*.isOffsite' => [
                'type' => 'toggle',
                ...
                'name' => 'themes.hypertext.menu.menuItems.*.isOffsite',
                'validation' => 'strict'
            ],
            'themes.hypertext.menu.menuItems.*.isNewWindow' => [
                'type' => 'toggle',
                ...
                'name' => 'themes.hypertext.menu.menuItems.*.isNewWindow',
                'validation' => 'strict'
            ],
            'themes.hypertext.menu.menuItems.*.fieldset' => [
                'type' => '_parent',
                'name' => 'themes.hypertext.menu.menuItems.*.fieldset',
                'form_field' => false
            ],
            'themes.hypertext.menu.menuItems.*.fieldset.rel' => [
                'type' => 'text',
                'label' => 'rel',
                'name' => 'themes.hypertext.menu.menuItems.*.fieldset.rel',
                'validation' => 'strict'
            ],
            'themes.hypertext.menu.menuItems.*.fieldset.name' => [
                'type' => 'text',
                'label' => 'Name',
                'name' => 'themes.hypertext.menu.menuItems.*.fieldset.name',
                'validation' => 'strict'
            ],
            'themes.hypertext.menu.menuItems.*.fieldset.title' => [
                'type' => 'text',
                'label' => 'Title',
                'name' => 'themes.hypertext.menu.menuItems.*.fieldset.title',
                'validation' => 'strict'
            ],
            'themes.hypertext.partials' => [
                'type' => '_parent',
                'name' => 'themes.hypertext.partials',
                'form_field' => false
            ],
            'themes.hypertext.partials.footer' => [
                'type' => '_parent',
                'name' => 'themes.hypertext.partials.footer',
                'form_field' => false
            ],
            'themes.hypertext.partials.footer.custom_footer_type' => [
                'type' => 'select',
                'classes' => 'fancy',
                'label' => 'Footer Type',
                'size' => 'large',
                ...
                'name' => 'themes.hypertext.partials.footer.custom_footer_type',
                'validation' => 'strict'
            ],
            'themes.hypertext.partials.footer.custom_footer' => [
                'type' => 'textarea',
        ...
        'nested' => [
            ...
            'themes' => [
                'hypertext' => [
                    'structure' => [
                        'inline_navbar' => 'themes.hypertext.structure.inline_navbar',
                        'inline_pagination' => 'themes.hypertext.structure.inline_pagination',
                        'use_decorators' => 'themes.hypertext.structure.use_decorators',
                        'html_mode' => 'themes.hypertext.structure.html_mode',
                        'use_favicon' => 'themes.hypertext.structure.use_favicon',
                        'show_date' => 'themes.hypertext.structure.show_date'
                    ],
                    'style' => [
                        'allowCSS' => 'themes.hypertext.style.allowCSS',
                        'allowJS' => 'themes.hypertext.style.allowJS',
                        'stylesheet' => 'themes.hypertext.style.stylesheet',
                        'include_type' => 'themes.hypertext.style.include_type',
                        'customCSS' => 'themes.hypertext.style.customCSS',
                        'configuration' => 'themes.hypertext.style.configuration',
                        'width' => 'themes.hypertext.style.width',
                        'image_cropping' => 'themes.hypertext.style.image_cropping'
                    ],
                    'menu' => [
                        'menuItems' => [
                            '*' => [
                                'text' => 'themes.hypertext.menu.menuItems.*.text',
                                'href' => 'themes.hypertext.menu.menuItems.*.href',
                                'isOffsite' => 'themes.hypertext.menu.menuItems.*.isOffsite',
                                'isNewWindow' => 'themes.hypertext.menu.menuItems.*.isNewWindow',
                                'fieldset' => [
                                    'rel' => 'themes.hypertext.menu.menuItems.*.fieldset.rel',
                                    'name' => 'themes.hypertext.menu.menuItems.*.fieldset.name',
                                    'title' => 'themes.hypertext.menu.menuItems.*.fieldset.title'
                                ]
                            ]
                        ]
                    ],
