...
return [
    ...
    'filename' => '/Applications/MAMP/htdocs/grav-admin/user/pages/03.blog/collection.md',
    'modified' => 1601071366,
    'data' => [
        'header' => [
        ...
        'frontmatter' => '',
        'markdown' => 'This is an example `collection` page that can be used as a blog, including several children for experimenting with.
